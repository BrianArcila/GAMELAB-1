<%-- 
    Document   : index
    Created on : 25/10/2018, 01:30:41 PM
    Author     : PC
--%>
...
<body>
    ...
    <header class="header">
        ...
        <div class="header__section2">
            <ul class="header__section2__list">
                <li>
                    <a href="../LOGIN-viejo/login.jsp"> <button type="button" class="btn btn-danger">Sign In</button></a>
                </li>
            </ul>
        </div>
    </header>
    ...
    <nav class="navbar">
        <ul class="navbar__list">
            ...
            <li><a href="/PLATFORMS/index.jsp">PLATFORMS</a></li>
